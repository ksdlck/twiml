(function(){
  var element, createDSL, def, dsl, __slice = [].slice;
  element = (function(){
  ...
  def = {
    ...
    record: ['Record', ['action', 'method', 'timeout', 'finishOnKey', 'maxLength', 'transcribe', 'transcribe', 'transcribeCallback', 'playBeep']],
